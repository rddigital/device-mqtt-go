...
WORKDIR $GOPATH/src/github.com/rddigital/device-mqtt-go
...
COPY --from=builder /go/src/github.com/rddigital/device-mqtt-go/cmd /
COPY --from=builder /go/src/github.com/rddigital/device-mqtt-go/LICENSE /
COPY --from=builder /go/src/github.com/rddigital/device-mqtt-go/Attribution.txt /
